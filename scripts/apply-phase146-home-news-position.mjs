...
if (!source.includes('// EBG_PHASE146_HOME_NEWS_POSITION')) {
...
await import('./apply-phase147-homepage-polish.mjs')
await import('./apply-phase148-universal-show-experience.mjs')
